...
public class Team_Dto3 {
	...
	private List<Player_Dto3> pdto;

	@Override
	public String toString() {
		return "Team_Dto3 [region_name=" + region_name + ", team_name=" + team_name + ", address=" + address
	...
	public List<Player_Dto3> getPdto() {
		return pdto;
	}

	public void setPdto(List<Player_Dto3> pdto) {
		this.pdto = pdto;
	}
