...
public class Player_Dto2 {
	...
	private Team_Dto2 tdto;

	@Override
	public String toString() {
		return "Player_Dto2 [player_name=" + player_name + ", position=" + position + ", back_no=" + back_no + ", tdto="
				+ tdto + "]";
	}
	...
	public Team_Dto2 getTdto() {
		return tdto;
	}

	public void setTdto(Team_Dto2 tdto) {
		this.tdto = tdto;
	}
