...
function pageNext(num, total, listNum, pageCnt){//출력할 페이지의 시작번호, 리스트의 총개수, 출력할 리스트의 개수, 출력할 페이지 번호 개수  
...
function pageLast(num, total, listNum, pageCnt){//출력할 페이지의 시작번호, 리스트의 총개수, 출력할 리스트의 개수, 출력할 페이지 번호 개수  
var index = Math.ceil(total/listNum); 
	var max = Math.ceil(index/pageCnt);
